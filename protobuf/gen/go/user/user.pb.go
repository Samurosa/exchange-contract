...
type TokenPairResponse struct {
	...
	AccessCreatesAt  *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=access_creates_at,json=accessCreatesAt,proto3" json:"access_creates_at,omitempty"`
	...
	RefreshCreatesAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refresh_creates_at,json=refreshCreatesAt,proto3" json:"refresh_creates_at,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *TokenPairResponse) GetAccessCreatesAt() *timestamppb.Timestamp {
	if x != nil {
		return x.AccessCreatesAt
	}
	return nil
}
...
func (x *TokenPairResponse) GetRefreshCreatesAt() *timestamppb.Timestamp {
	if x != nil {
		return x.RefreshCreatesAt
	}
	return nil
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\x0e\n" +
	"\fEmptyRequest\"\xeb\x01\n" +
	...
	"\tdevice_id\x18\x03 \x01(\tB\t\xfaB\x06r\x04\x10\x01\x18@R\bdeviceId\"\xff\x02\n" +
	"\x11TokenPairResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12F\n" +
	"\x11access_expires_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0faccessExpiresAt\x12F\n" +
	"\x11access_creates_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x0faccessCreatesAt\x12H\n" +
	"\x12refresh_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x10refreshExpiresAt\x12H\n" +
	"\x12refresh_creates_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x10refreshCreatesAt\"E\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12>\n" +
	"\rlogged_out_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vloggedOutAt\"o\n" +
	"\x11ChangeUserRequest\x12,\n" +
	"\fold_password\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x06\x18@R\voldPassword\x12,\n" +
	"\fnew_password\x18\x02 \x01(\tB\t\xfaB\x06r\x04\x10\x06\x18@R\vnewPassword\"\x83\x01\n" +
	...
	"\n" +
	"ROLE_ADMIN\x10\x042\xc5\x05\n" +
	"\vUserService\x12E\n" +
	"\fRegistration\x12\x19.user.RegisterUserRequest\x1a\x1a.user.RegisterUserResponse\x125\n" +
	"\aGetUser\x12\x12.user.EmptyRequest\x1a\x16.user.UserInfoResponse\x12K\n" +
	"\x0eUpdateUserInfo\x12\x1b.user.UpdateUserInfoRequest\x1a\x1c.user.UpdateUserInfoResponse\x12:\n" +
	"\n" +
	"DeleteUser\x12\x12.user.EmptyRequest\x1a\x18.user.DeleteUserResponse\x12C\n" +
	...
	"\x05Login\x12\x12.user.LoginRequest\x1a\x17.user.TokenPairResponse\x123\n" +
	"\x06Logout\x12\x13.user.LogoutRequest\x1a\x14.user.LogoutResponse\x12@\n" +
	"\x10LogoutAllDevices\x12\x16.user.LogoutAllRequest\x1a\x14.user.LogoutResponse\x12A\n" +
	"\vGetBalances\x12\x12.user.EmptyRequest\x1a\x1e.user.UserBalancesInfoResponse\x12B\n" +
...
var file_user_user_proto_goTypes = []any{
	...
	(*LogoutAllRequest)(nil),         // 15: user.LogoutAllRequest
	(*RefreshTokenRequest)(nil),      // 16: user.RefreshTokenRequest
	(*LogoutResponse)(nil),           // 17: user.LogoutResponse
	(*ChangeUserRequest)(nil),        // 18: user.ChangeUserRequest
	(*ChangeUserResponse)(nil),       // 19: user.ChangeUserResponse
	(*timestamppb.Timestamp)(nil),    // 20: google.protobuf.Timestamp
	(*shared.Money)(nil),             // 21: shared.Money
}
var file_user_user_proto_depIdxs = []int32{
	...
	20, // 2: user.UserInfoResponse.created_at:type_name -> google.protobuf.Timestamp
	20, // 3: user.UserInfoResponse.updated_at:type_name -> google.protobuf.Timestamp
	20, // 4: user.UpdateUserInfoResponse.updated_info_at:type_name -> google.protobuf.Timestamp
	20, // 5: user.DeleteUserResponse.deleted_user_at:type_name -> google.protobuf.Timestamp
	21, // 6: user.DepositRequest.amount:type_name -> shared.Money
	1,  // 7: user.DepositResponse.balance:type_name -> user.Balance
	20, // 8: user.TokenPairResponse.access_expires_at:type_name -> google.protobuf.Timestamp
	20, // 9: user.TokenPairResponse.access_creates_at:type_name -> google.protobuf.Timestamp
	20, // 10: user.TokenPairResponse.refresh_expires_at:type_name -> google.protobuf.Timestamp
	20, // 11: user.TokenPairResponse.refresh_creates_at:type_name -> google.protobuf.Timestamp
	1,  // 12: user.UserBalancesInfoResponse.balances:type_name -> user.Balance
	20, // 13: user.LogoutResponse.logged_out_at:type_name -> google.protobuf.Timestamp
	20, // 14: user.ChangeUserResponse.user_password_changed_at:type_name -> google.protobuf.Timestamp
	2,  // 15: user.UserServer.Registration:input_type -> user.RegisterUserRequest
	4,  // 16: user.UserServer.GetUser:input_type -> user.EmptyRequest
	6,  // 17: user.UserServer.UpdateUserInfo:input_type -> user.UpdateUserInfoRequest
	4,  // 18: user.UserServer.DeleteUser:input_type -> user.EmptyRequest
	18, // 19: user.UserServer.ChangePassword:input_type -> user.ChangeUserRequest
	9,  // 20: user.UserServer.Deposit:input_type -> user.DepositRequest
	11, // 21: user.UserServer.Login:input_type -> user.LoginRequest
	14, // 22: user.UserServer.Logout:input_type -> user.LogoutRequest
	15, // 23: user.UserServer.LogoutAllDevices:input_type -> user.LogoutAllRequest
	4,  // 24: user.UserServer.GetBalances:input_type -> user.EmptyRequest
	16, // 25: user.UserServer.RefreshToken:input_type -> user.RefreshTokenRequest
	3,  // 26: user.UserServer.Registration:output_type -> user.RegisterUserResponse
	5,  // 27: user.UserServer.GetUser:output_type -> user.UserInfoResponse
	7,  // 28: user.UserServer.UpdateUserInfo:output_type -> user.UpdateUserInfoResponse
	8,  // 29: user.UserServer.DeleteUser:output_type -> user.DeleteUserResponse
	19, // 30: user.UserServer.ChangePassword:output_type -> user.ChangeUserResponse
	10, // 31: user.UserServer.Deposit:output_type -> user.DepositResponse
	12, // 32: user.UserServer.Login:output_type -> user.TokenPairResponse
	17, // 33: user.UserServer.Logout:output_type -> user.LogoutResponse
	17, // 34: user.UserServer.LogoutAllDevices:output_type -> user.LogoutResponse
	13, // 35: user.UserServer.GetBalances:output_type -> user.UserBalancesInfoResponse
	12, // 36: user.UserServer.RefreshToken:output_type -> user.TokenPairResponse
